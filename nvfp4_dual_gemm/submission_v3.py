...
class Sm100BlockScaledDualGemmKernel:
    """
    Optimized Dual GEMM kernel using warp specialization pattern from nvfp4_gemm.
    ...
    def kernel(
        ...
        # ---------- MMA warp: Consumer + Dual GEMM + ACC producer ----------
            ...
            # Allocate tensor memory for ACC1, ACC2, SFA, SFB1, SFB2
            acc_tmem_ptr = tmem.retrieve_ptr(self.acc_dtype)
            
            # ACC1 tensor
            tCtAcc1 = cute.make_tensor(acc_tmem_ptr, tCtAcc_fake.layout)
            
            # ACC2 tensor (offset by ACC1 size)
...
def compile_kernel():
    ...
    # Use same tile and cluster shape as optimized nvfp4_gemm
    my_kernel = Sm100BlockScaledDualGemmKernel((128, 64), (1, 4))
